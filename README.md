...
the design doc [`docs/specs/graph-boolean-ivm-spec.md`](./docs/specs/graph-boolean-ivm-spec.md)). The shared
...
Design doc: [`docs/specs/graph-boolean-ivm-spec.md`](./docs/specs/graph-boolean-ivm-spec.md); implementation
