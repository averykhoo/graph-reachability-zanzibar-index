...
| **`ZT-P5` bullet 2** (fragment exclusions are proof-scope, not behavioral) | **no explicit disposition** | partly addressed by the state-gate work. Object wildcards have still never been probed at STATE level — the same inference class that failed on 2026-07-17. |
...
| **`ZT-P5` bullet 5** (from-chain TARGET reachability, asserted 2026-07-13, never re-derived) | **no disposition** | still un-re-derived across three later widenings. Carried on the live board's Standing/latent item. |
