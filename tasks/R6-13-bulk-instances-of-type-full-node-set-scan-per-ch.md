...
`index_v4/bulk_backfill.py::_BulkBackfill._instances_of_type`

**Measured (2026-08-17 motivating-measurement pass):** **0 calls** though the bulk path plainly ran — the bulk twin of `R6-3`, needing the same star/wildcard shapes.
...
- [`docs/perf-round6-audit-2026-08.md`](docs/perf-round6-audit-2026-08.md) §`### R6-13` — the entry, **including its verifier corrections**
...
- `index_v4/bulk_backfill.py::_BulkBackfill._instances_of_type` — the code
