...
| audited theorems (`#print axioms` in `Audit.lean`) | **582** |
| audit identity pin (`audited_theorems.txt`) | **582** |
| headline definition pin | **160** rows (**153** declarations + ambient) |
| `CORRESPONDENCE.md` anchors | **537** (**332** Python + **205** Lean) |
| `corpus.SCHEMAS` | **26** |
...
| gate floors (`verify.sh`) | `MIN_CONF_ALL`=495 (=104+391), `MIN_TESTS_ALL`=923, `EXPECTED_MIN_AUDITS`=460 |
