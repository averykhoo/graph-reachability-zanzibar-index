...
| `CORRESPONDENCE.md` anchors | **527** (**324** Python + **203** Lean) |
| `corpus.SCHEMAS` | **26** |
...
| gate floors (`verify.sh`) | `MIN_CONF_ALL`=495 (=104+391), `MIN_TESTS_ALL`=903, `EXPECTED_MIN_AUDITS`=460 |
